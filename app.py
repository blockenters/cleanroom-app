...
def main():
    ...
    with main_container:
        col1, main_col, col3 = st.columns([1,4,1])
        ...
        with main_col:
            ...
            with example_col1:
                st.image("images/clean.png", caption="깨끗한 방", use_container_width=True)
            ...
            with example_col2:
                st.image("images/messy.png", caption="지저분한 방", use_container_width=True)
